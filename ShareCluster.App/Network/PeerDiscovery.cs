...
namespace ShareCluster.Network
{
    public class PeerDiscovery
    {
        ...
        public PeerDiscovery(ILoggerFactory loggerFactory, NetworkSettings settings, AnnounceMessage announce, IPeerRegistry registry)
        {
            ...
            using (client = new UdpClient())
            {
                ...
                while(!timeout.IsCancellationRequested)
                {
                    ...
                    try
                    {
                        ...
                        registry.RegisterPeer(new PeerInfo(response, responseData.RemoteEndPoint.Address));
                    }
